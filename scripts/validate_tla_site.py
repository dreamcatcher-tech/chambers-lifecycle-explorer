...
def validate_projection(payload: dict) -> None:
    ...
    if len(coverage.get("releaseKernels", [])) != 12:
    ...
    if len(controls) != 24 or any(control.get("status") != "expected_counterexample" for control in controls):
